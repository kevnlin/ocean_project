...
(a trained model's stability is reported by experiments/synthetic/25_dfs_report.py).

Run:  python experiments/synthetic/23_dfs_evidence_probes.py
Out:  reports/synthetic/dfs_evidence_probes.md, outputs/cache/dfs_evidence_probes.json
"""
...
L.append(f"\n---\n*Generated by `experiments/synthetic/23_dfs_evidence_probes.py` in "
         f"{meta['seconds']:.1f} s.*")
path = os.path.join(C.REPORTS_SYNTHETIC, "dfs_evidence_probes.md")
open(path, "w").write("\n".join(L) + "\n")
