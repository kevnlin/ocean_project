...
agreement can be inferred from a single track.  See `crosscheck.render_report`.
  ...
  .venv/bin/python experiments/real_data/47_argo_reports.py
"""
...
HEADER = """<!-- generated by experiments/real_data/47_argo_reports.py — do not edit by hand -->
...
def report_final() -> str:
    ...
    if ran:
        ...
        L += ["Track A has run. **Track B has not.** Every Track B cell above "
              "is `pending`.", "",
              "```bash",
              ".venv/bin/python experiments/real_data/47_argo_reports.py --track-b <dir>",
              "```", ""]
    return "\n".join(L)
...
# ------------------------------------------------------------ intern (B)
INTERN_HEADER = """<!-- generated by experiments/real_data/47_argo_reports.py -->
