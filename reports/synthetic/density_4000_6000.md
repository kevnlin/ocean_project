...
Rerun: `python experiments/synthetic/31_density_powerlaw.py`.*
...
CUDA_VISIBLE_DEVICES=N PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \
  python experiments/synthetic/08_density_ablation.py --seed 1234 --densities 4000,6000 \
  --methods clim_floor,unet_depthwise --out-suffix _ext --cpu-tensors

python experiments/synthetic/merge_density_json.py --seeds 1234 --dry-run   # inspect
python experiments/synthetic/merge_density_json.py --seeds 1234             # idempotent
python experiments/synthetic/31_density_powerlaw.py                         # re-fit
```
